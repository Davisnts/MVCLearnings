...
export class PalestranteService {
  baseURL = environment.apiURL + 'palestrante';
  ...
  public getPalestranteByTema(tema: string): Observable<Palestrante[]> {
    return this.http
  ...
  public updatePalestrante(palestrante: Palestrante): Observable<Palestrante> {
    return this.http
